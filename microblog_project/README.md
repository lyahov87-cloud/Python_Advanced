...
Бэкенд-приложение для корпоративной сети микроблогов на базе **FastAPI**, **PostgreSQL** и **SQLAlchemy 2.0**.
...
Для развертывания проекта в prod-окружении выполните команду в корневой директории:
...
- **Интерактивная документация Swagger API:** [http://localhost:8000/api/docs](http://localhost:8000/api/docs)
